    ...
    <body>
        <div class="ebanner">
            <figure>
                ...
                <a href='#mlbb'><img src="img/b2.png" id="b2"></a>
                <a href='#valorant'><img src="img/b3.png" id="b3"></a>
                <a href='#warzone'><img src="img/b4.png" id="b4"></a>
        ...
        <div class="events">
            ...
            <div class="event-card">
                <div class="event-front" id="warzone">
                    <img src="img/b4.png" width="100%">
                </div>
                <div class="event-back">
                    <h2>WARZONE S2 : GAMING FUN CAMP</h2>
                    <div class="event-details">
                        <div class="event-desc">
                            <img src="img/warzone.png">
